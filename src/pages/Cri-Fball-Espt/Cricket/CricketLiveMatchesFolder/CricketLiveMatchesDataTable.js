...
const CricketLiveMatchesDataTable = (props) => {
  ...
  const handleClick = () => {
    navigate("/Cricket-Scoreboard", {
      state: { data: props.obj.Events[0].Eid },
    });
  };
            ...
            <div className="cricket-team1">
              ...
              props.obj.Events[0].Tr1CO1 ? (
                <p className="team-score-color">
                  ...
                  " "}
                  {/* {props.obj.Events[0].Tr1C1}/{props.obj.Events[0].Tr1CW1}
                  (Ov {props.obj.Events[0].Tr1CO1}) */}
                </p>
              ) : `( yet to bat )`}
              ...
              <p className="team-score-color">
                {props.obj.Events[0].Tr1C2}/{props.obj.Events[0].Tr1CW2}(
                {props.obj.Events[0].Tr1CO2})
              </p>
              ) : null}
            </div>
          ...
          <div className="col-md-3 po-2">
            <div className="cricket-team2">
              ...
              props.obj.Events[0].Tr2CO1 ? (
                <p className="team-score-color">
                  {/* {props.obj.Events[0].Tr2C1}/{props.obj.Events[0].Tr2CW1}(
                  {props.obj.Events[0].Tr2CO1}){" "} */}
                  {
