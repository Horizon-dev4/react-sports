...
import CricketNewsDetailsDataTable from "./CricketNewsDetailsDataTable";
        ...
        if (location.state && location.state.data) {
            ...
            if (newsid) {
                options = {
                    ...
                    params: { id: newsid },
                    headers: {
                        "x-rapidapi-key": '39bcf5b7cemshf14ca5c81884017p11f3f4jsnce700681c6cd',
            ...
            axios
                .request(options)
                .then((response1) => {
                    const contentList = response1.data.article.body.map(d => d.data.content);
                    ...
                    const plainParagraphs = paragraph.map((p) => {
                        return p.props.children.replace(/(<([^>]+)>)/ig, "");
                    });
                                ...
                                <div className="col-md-12">
                                    ...
                                    <div className="wrapper-users">
                                        <div className="container">
                                            ...
                                            <p className="category-label">{location.state.cat + ' , ' + location.state.published}</p>
