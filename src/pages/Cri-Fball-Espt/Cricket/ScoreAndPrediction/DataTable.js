...
class DataTable extends Component {
  ...
  <tr>  
    ...
    <th colSpan="7" class="table-header text-end">{value1.Pt + " - " + value1.Wk + " (" + value1.Ov + " Ov)"}</th>
  </tr>
</thead>
                ...
                <tbody>
                  ...
                  <tr>
                    <td colSpan="8">{'Extras '+value1.Ex+' (WB '+value1.WB+', LB '+value1.LB+', NB '+ value1.NB + ', Pen '+value1.Pen+')'} </td>
                  </tr>
                  {/* fall of wicket section started here */}
                  <tr>
                    <td colSpan="8"><h5>Fall of wickets</h5>{value1.FoW.map(player => (
                      player.R +   "-" +player.WkN + " (" +findPlayer(player.Pid) + ", " + player.B + "),  "+" "
